...
/**
 * LayoutWrapper com Outlet para rotas aninhadas
 * O Sidebar permanece montado e apenas o conteúdo (Outlet) é atualizado
 */
const LayoutWrapper = () => {
  const user = useUser();
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <main className="flex-1 overflow-auto w-full bg-background">
        ...
        {/* Outlet - apenas este conteúdo é atualizado na navegação */}
        <div className="w-full px-4 md:px-6 lg:px-8 py-4 md:py-6 max-w-[1600px] mx-auto min-h-0">
          <Outlet />
        </div>
      </main>
