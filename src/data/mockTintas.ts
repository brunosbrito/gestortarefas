...
export const mockFornecedores: FornecedorServicoInterface[] = [
  ...
  {
    id: 4,
    nome: 'Metalúrgica Prec. Usinagem SP',
    categorias: ['usinagem'],
    valorJateamentoM2: 0,
    valorPinturaM2: 0,
    contato: 'Roberto Costa',
    telefone: '(11) 97654-3210',
    email: 'contato@ussp.com.br',
    observacoes: 'Torneamento, fresamento, furação CNC',
    ativo: true,
  },
  {
    id: 5,
    nome: 'Transportadora Industrial Sudeste',
    categorias: ['transporte'],
    valorJateamentoM2: 0,
    valorPinturaM2: 0,
    contato: 'Ana Lima',
    telefone: '(11) 96543-2109',
    email: 'operacoes@tis.com.br',
    observacoes: 'Carga especial, escolta, içamento',
    ativo: true,
  },
];
